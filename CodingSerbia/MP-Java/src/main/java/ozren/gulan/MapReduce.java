...
public class MapReduce {
  ...
  public static void main(String[] args) throws Exception {
    runJob(new Path("/some/path/students.txt"), new Path("/some/path/rating.txt"), new Path(
        "/results/ratings_java"), new Configuration());
  }

  @SuppressWarnings("deprecation")
  protected static void runJob(Path studentsPath, Path ratingsPath, Path outputPath,
